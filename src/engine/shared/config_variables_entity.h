...
// Quick Actions
MACRO_CONFIG_INT(ClResetPlayerActionMouse, ec_reset_playeraction_mouse, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Reset position of mouse when opening the player actions menu")
